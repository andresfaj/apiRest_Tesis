...
export class RstateService {
  ...
  updateRstate(fd: FormData, dataUser: RealState){
    fd.append('originalnamevr', dataUser.originalnamevr);
    fd.append('filenamevr', dataUser.filenamevr);
    fd.append('pathvr', dataUser.pathvr);
    fd.append('mimetypevr', dataUser.mimetypevr);
    if(dataUser.sizevr != null){
      fd.append('sizevr', dataUser.sizevr.toString());
    }
    ...
    if(dataUser.size != null){
      fd.append('size', dataUser.size.toString());
    }
    fd.append('typeProperty', dataUser.typeProperty);
    fd.append('typeOffer', dataUser.typeOffer);
    fd.append('price', dataUser.price.toString());
    ...
    fd.append('user', dataUser.user);
    fd.append('disabled', dataUser.disabled.toString());
    return this.http.put(this.URL_API + `/${dataUser._id}`, fd);
  }
